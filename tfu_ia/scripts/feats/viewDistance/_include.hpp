...
class TAWVD_activeText 
{
	...
	colorDisabled[] = {1,1,1,0.25};	//added by ben
...
class TAW_VD 
{
	...
	class controls 
	{
		...
		class VD_onfoot_slider : TAWVD_RscXSliderH 
		{
			idc = 2901;
			text = "";
			onSliderPosChanged = "[0,_this select 1] call viewDistance_fnc_onSliderChange;";
		...
		class VD_air_slider : TAWVD_RscXSliderH 
		{
			idc = 2921;
			text = "";
			onSliderPosChanged = "[2,_this select 1] call viewDistance_fnc_onSliderChange;";
		...
		class VD_terr_low : TAWVD_activeText
		{
			idc = -1;
			text = "Low";
			action = "['low'] call viewDistance_fnc_onTerrainChange;";
			sizeEx = 0.04;
		...
		class VD_terr_normal : TAWVD_activeText
		{
			idc = -1;
			text = "Normal";
			action = "['norm'] call viewDistance_fnc_onTerrainChange;";
			sizeEx = 0.04;
		...
		class VD_terr_high : TAWVD_activeText
		{
			idc = -1;
			text = "High";
			action = "['high'] call viewDistance_fnc_onTerrainChange;";
			sizeEx = 0.04;
