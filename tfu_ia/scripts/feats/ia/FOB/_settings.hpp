class fob {
	...
	maxGroup = 5;
	maxVehicle = 2;
	newHint = "<t align='center'><t size='2.2'>FOB created</t><br/><t size='1.5' color='#00B2EE'></t><br/>____________________<br/>We have created a Forward Operating Base for you to use. You got %1 minutes to bring the supplies there.</t>";
