class IA {
	tag = "IA";
	class functions {
		class forcedGarrison { file="feats\ia\forcedGarrison.sqf"; };
		class giveReward { file="feats\ia\giveReward.sqf"; };
		class placeAirPatrol { file="feats\ia\placeAirPatrol.sqf"; };
		class placeCivPatrol { file="feats\ia\placeCivPatrol.sqf"; };
