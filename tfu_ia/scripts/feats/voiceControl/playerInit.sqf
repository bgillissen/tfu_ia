...
if ( (["voiceControl"] call core_fnc_getParam) == 0 ) exitWith {};
...
VC_allowed = [];
VC_open = [];
VC_message = ["voiceControl", "message"] call core_fnc_getSetting;
...
private _delay = ["voiceControl", "loopDelay"] call core_fnc_getSetting;
private _disabled = ["voiceControl", "disabled"] call core_fnc_getSetting;
private _players = ["voiceControl", "players"] call core_fnc_getSetting;
private _groupLeader = ["voiceControl", "groupLeader"] call core_fnc_getSetting;
private _admins = ["voiceControl", "admins"] call core_fnc_getSetting;
private _adminList = ["voiceControl", "adminList"] call core_fnc_getSetting;
