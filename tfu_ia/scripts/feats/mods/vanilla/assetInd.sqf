...
_out set [AVI, [_backpacks, _items, _weapons, _ammo]];
...
_out set [RGVI, [_launcher, _mg, _sRifle, _mRifle, _sScope, _mScope, _oScope, _backpack]];
...
_out set [CVI, [_backpacks, _items, _weapons, _ammo]];
...
_out set [AVVI, [_heli, _plane, _tank]];
...
_out set [SVI, [_rt, _crates, _pGroups, _sGroups, _pilot, _crew, _officer, _garrison, 
...
_out set [VVI, [_car, _carArmed, _apc, _tank, _aaTank, _planeCAS, _planeAA, _planeTransport, _uav, 
...
_out set [RLVI, [_hq, _sl, _tl, _medic, _lmg, _hmg, _assHMG, _at, _assAT, _sniper, _marksman,
