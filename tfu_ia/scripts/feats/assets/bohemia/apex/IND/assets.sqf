/*
@filename: feats\assets\bohemia\apex\IND\assets.sqf
Author:
	Ben
Description:
...
_out set [RG_AI, [_launcher, _mg, _sRifle, _mRifle, _sScope, _mScope, _oScope, _mbrItem, _backpack]];
...
_out set [S_AI, [_rt, _crates, _pGroups, _sGroups, _pilot, _crew, _officer, _garrison, _civ, 
